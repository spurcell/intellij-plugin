 ...
 * from the specification file <tt>Lo.flex</tt>
 */
class LoLexer implements FlexLexer {
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          case 1: 
            { yybegin(YYINITIAL); return LoTypes.KEY;
            }
          case 8: break;
          case 2: 
          ...
          case 10: break;
          case 4: 
            { yybegin(YYINITIAL); return LoTypes.COMMENT;
            }
          case 11: break;
          case 5: 
            { yybegin(WAITING_VALUE); return LoTypes.SEPARATOR;
            }
          case 12: break;
          case 6: 
            { yybegin(YYINITIAL); return LoTypes.VALUE;
            }
          case 13: break;
          case 7: 
